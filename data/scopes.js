const scopes = {
  ...
  Science: {
    ...
    Eight: {
      scopeDescription: 'Covers topics in biological, physical, and environmental sciences.',
      scopeDetails: [
    ...
    Nine: {
      scopeDescription: 'Covers topics in physics, chemistry, biology, and Earth sciences.',
      scopeDetails: [
    ...
    Ten: {
      scopeDescription: 'Covers various topics in chemistry, biology, and Earth sciences.',
      scopeDetails: [
        'Chemical Reactions',
        'Transpiration in Plants',
    ...
    Twelve: {
      scopeDescription: 'Covers advanced topics in physics, biology, and geology.',
      scopeDetails: [
        'Nuclear Fission',
        'Unit of Electric Current',
        'Electromagnetic Waves',
