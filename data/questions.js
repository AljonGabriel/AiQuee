const questions = {
  ...
  Science: {
    Seven: [
      ...
      },
      {
        ...
        options: [
          ...
          { text: 'To break down food for energy', isCorrect: false },
          {
            ...
            isCorrect: true,
            explanation: 'The main function of the respiratory system is to exchange gases and enable breathing.',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        options: [
          { text: 'Chemical to electrical', isCorrect: false },
          {
            ...
            isCorrect: true,
            explanation: 'The energy transformation in a blender is from electrical to mechanical.',
          },
      ...
      },
      {
        ...
        options: [
          ...
          { text: 'Mesosphere', isCorrect: false },
          {
            text: 'Troposphere',
            isCorrect: true,
            explanation: "The layer of the Earth's atmosphere closest to the Earth's surface is the Troposphere.",
          },
      ...
      },
      {
        ...
        options: [
          { text: 'The rotation of the Earth', isCorrect: false },
          {
            ...
            isCorrect: true,
            explanation: "The tides in the Earth's oceans are caused by the pull of the Moon's gravity.",
          },
      ...
      },
      {
        ...
        options: [
          ...
          { text: 'Water', isCorrect: true, explanation: 'Water is a renewable resource.' },
        ],
      },
      {
        ...
        options: [
          { text: 'Melting', isCorrect: false },
          {
            text: 'Weathering',
            isCorrect: true,
            explanation: 'The process by which rocks are broken down into smaller pieces is called weathering.',
          },
      ...
      },
      {
        ...
        options: [
          ...
          { text: 'Lever', isCorrect: true, explanation: 'A seesaw is a type of simple machine known as a lever.' },
      ...
      },
      {
        ...
        options: [
          { text: 'Mantle', isCorrect: false },
          {
            text: 'Core',
            isCorrect: true,
            explanation: 'The dense, solid, and hottest layer of the Earth is the Core.',
          },
    ...
    Eight: [
      ...
      },
      {
        ...
        options: [
          { text: 'Oxygen', isCorrect: false },
          { text: 'Carbon dioxide', isCorrect: true, explanation: 'Carbon dioxide is essential for photosynthesis.' },
          { text: 'Nitrogen', isCorrect: false },
          { text: 'Hydrogen', isCorrect: false },
        ],
      },
      ...
      },
      {
        ...
        options: [
          { text: 'Photosynthesis', isCorrect: false },
          {
            text: 'Digestion',
            isCorrect: true,
            explanation: 'The process of converting food into energy is called digestion.',
          },
          { text: 'Respiration', isCorrect: false },
          { text: 'Transpiration', isCorrect: false },
        ],
      },
      {
        ...
        options: [
          { text: 'To store energy', isCorrect: false },
          {
            ...
            isCorrect: true,
            explanation: 'The main function of the nucleus in a cell is to control cell activities.',
          },
        ...
        options: [
          {
            text: 'Venus',
            isCorrect: true,
            explanation: "The planet known as the 'Morning Star' or 'Evening Star' is Venus.",
          },
      ...
      },
      {
        ...
        options: [
          ...
          { text: 'Burning wood', isCorrect: true, explanation: 'Burning wood is an example of a chemical change.' },
      ...
      },
      {
        ...
        options: [
          { text: 'Coal', isCorrect: false },
          { text: 'Natural gas', isCorrect: false },
          { text: 'Solar energy', isCorrect: true, explanation: 'Solar energy is an example of a renewable resource.' },
          { text: 'Petroleum', isCorrect: false },
        ],
      },
      {
        ...
        options: [
          { text: 'To store water', isCorrect: false },
          {
            ...
            isCorrect: true,
            explanation: 'The function of the mitochondria in a cell is to produce energy.',
          },
      ...
      },
      {
        ...
        options: [
          ...
          { text: 'A ramp', isCorrect: true, explanation: 'A ramp is an example of an inclined plane' },
      ...
      },
      {
        ...
        options: [
          ...
          { text: 'Reflection', isCorrect: true, explanation: 'Reflection is NOT a method of heat transfer.' },
    ...
    Nine: [
      ...
      },
      {
        ...
        options: [
          ...
          { text: 'H2O', isCorrect: true, explanation: 'The chemical symbol for water is H2O.' },
        ],
      },
      {
        question: 'Which gas do plants absorb from the atmosphere during photosynthesis?',
      ...
      },
      {
        ...
        options: [
          ...
          { text: 'To break down waste', isCorrect: false },
          {
            ...
            isCorrect: true,
            explanation: 'The function of the ribosomes in a cell is to synthesize proteins.',
          },
        ],
      },
      {
        ...
        options: [
          { text: 'Natural gas', isCorrect: false },
          { text: 'Wind energy', isCorrect: true, explanation: 'Wind energy is a renewable energy source.' },
          { text: 'Coal', isCorrect: false },
          { text: 'Petroleum', isCorrect: false },
        ],
      },
      {
        ...
        options: [
          ...
          { text: 'Liver', isCorrect: true, explanation: 'The largest organ in the human body is the liver.' },
        ...
        options: [
          {
            text: 'Photosynthesis',
            isCorrect: true,
            explanation: 'The process by which plants make their own food is called photosynthesis.',
          },
          { text: 'Respiration', isCorrect: false },
          { text: 'Transpiration', isCorrect: false },
          { text: 'Pollination', isCorrect: false },
      ...
      },
      {
        ...
        options: [
          ...
          { text: 'Gypsum', isCorrect: true, explanation: 'Gypsum is NOT a type of rock.' },
        ],
      },
      {
        question: 'What is the process by which rocks are broken down into smaller pieces?',
      ...
      },
      {
        ...
        options: [
          { text: 'Venus', isCorrect: false },
          { text: 'Mars', isCorrect: true, explanation: "The planet known as the 'Red Planet' is Mars." },
          { text: 'Jupiter', isCorrect: false },
          { text: 'Saturn', isCorrect: false },
        ],
      },
      {
        ...
        options: [
          ...
          { text: 'To break down food for energy', isCorrect: false },
          {
            text: 'To exchange gases and help us breathe',
            isCorrect: true,
            explanation: 'The main function of the respiratory system is to exchange gases and help us breathe.',
          },
          ,
        ],
      },
      {
        ...
        options: [
          { text: 'Melting', isCorrect: false },
          {
            text: 'Evaporation',
            isCorrect: true,
            explanation: 'The process by which water changes from a liquid to a gas is called evaporation.',
          },
          { text: 'Condensation', isCorrect: false },
          { text: 'Freezing', isCorrect: false },
        ],
      },
      {
        ...
        options: [
          ...
          { text: 'Pulley', isCorrect: false },
          {
            text: 'Lever',
            isCorrect: true,
            explanation: 'A seesaw is an example of a simple machine known as a lever.',
          },
          { text: 'Inclined plane', isCorrect: false },
        ],
      },
    ...
    Ten: [
      ...
      },
      {
        ...
        options: [
          { text: 'Natural gas', isCorrect: false },
          { text: 'Solar energy', isCorrect: true, explanation: 'Solar energy is a renewable energy source.' },
          { text: 'Coal', isCorrect: false },
          { text: 'Petroleum', isCorrect: false },
        ],
      },
      {
        ...
        options: [
          ...
          { text: 'To synthesize proteins', isCorrect: false },
          {
            ...
            isCorrect: true,
            explanation: 'The function of the chloroplasts in plant cells is to carry out photosynthesis.',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        options: [
          { text: 'Sour taste', isCorrect: true, explanation: 'A property of acids is that they have a sour taste.' },
    ...
    Eleven: [
      ...
      },
      {
        ...
        options: [
          ...
          { text: 'Ampere', isCorrect: true, explanation: 'The unit of electric current is Ampere.' },
        ],
      },
      {
        ...
        options: [
          ...
          { text: 'Microwaves', isCorrect: false },
          {
            text: 'X-rays',
            isCorrect: true,
            explanation: 'X-rays are a type of electromagnetic wave with the shortest wavelength.',
          },
      ...
      },
      {
        ...
        options: [
          { text: 'To fight infections', isCorrect: false },
          {
            ...
            isCorrect: true,
            explanation: 'The function of red blood cells in the human body is to carry oxygen.',
          },
          { text: 'To produce energy', isCorrect: false },
      ...
      },
      {
        ...
        options: [
          ...
          { text: 'To break down waste', isCorrect: false },
          {
            text: 'To synthesize proteins',
            isCorrect: true,
            explanation: 'The main function of ribosomes in a cell is to synthesize proteins.',
          },
        ],
      },
      {
        ...
        options: [
          ...
          { text: 'Gamma decay', isCorrect: false },
          {
            text: 'Beta decay',
            isCorrect: true,
            explanation: 'Beta decay is a type of nuclear decay that emits a beta particle.',
          },
      ...
      },
      {
        ...
        options: [
          { text: 'Oxygen', isCorrect: false },
          {
            text: 'Carbon dioxide',
            isCorrect: true,
            explanation: 'The gas that is essential for photosynthesis is carbon dioxide.',
          },
          { text: 'Nitrogen', isCorrect: false },
          { text: 'Hydrogen', isCorrect: false },
        ],
        ...
        options: [
          {
            text: 'To fight infections',
            isCorrect: true,
            explanation: 'The function of the white blood cells in the human body is to fight infections.',
          },
          { text: 'To carry oxygen', isCorrect: false },
          { text: 'To produce energy', isCorrect: false },
          { text: 'To remove waste', isCorrect: false },
    ...
    Twelve: [
      ...
      },
      {
        ...
        options: [
          ...
          { text: 'Watt', isCorrect: false },
          { text: 'Ohm', isCorrect: false },
          { text: 'Ampere', isCorrect: true, explanation: 'The unit of electric current is Ampere (A).' },
        ],
      },
      {
        ...
        options: [
          {
            text: 'Radio waves',
            isCorrect: true,
            explanation: 'Radio waves are a type of electromagnetic wave with the longest wavelength.',
          },
          { text: 'Microwaves', isCorrect: false },
      ...
      },
      {
        ...
        options: [
          ...
          { text: 'To break down waste', isCorrect: false },
          {
            text: 'To synthesize proteins',
            isCorrect: true,
            explanation: 'The main function of the ribosomes in a cell is to synthesize proteins.',
          },
        ],
      },
      {
        ...
        options: [
          ...
          { text: 'Gamma decay', isCorrect: false },
          {
            text: 'Beta decay',
            isCorrect: true,
            explanation: 'The type of nuclear decay that emits a beta particle is called Beta decay.',
          },
          { text: 'Electron decay', isCorrect: false },
        ],
      },
  ...
  Math: {
    Seven: [
      ...
      },
      {
        ...
        options: [
          ...
          { text: '10x + 13', isCorrect: true, explanation: 'Simplified expression: 2x + 3.' },
    ...
    Ten: [
      ...
      {
        question: 'What is the slope of the line passing through the points (2, 4) and (6, 10)?',
        options: [
          { text: '2', isCorrect: false },
          {
            text: '3',
      ...
      {
        question: 'Find the midpoint of the line segment with endpoints (1, 3) and (5, 7).',
        options: [
    ...
    Eleven: [
        ...
        options: [
          {
            text: '(x + 3)(x - 3)',
            isCorrect: true,
            explanation: 'The expression is a difference of squares, so it factors as (x + 3)(x - 3).',
          },
      ...
      {
        question: 'Find the area of a triangle with sides of length 8 cm, 10 cm, and 12 cm.',
        options: [
          {
            text: '32 square cm',
            isCorrect: true,
    ...
    Twelve: [
      ...
      {
        question: 'If A = {1, 2, 3, 4} and B = {3, 4, 5, 6}, find the intersection A ∩ B.',
        options: [
          {
            text: 'A ∩ B = {3, 4}',
            isCorrect: true,
      ...
      {
        question: 'Find the value of k if (k - 1) is a factor of the polynomial 2k^3 + 3k^2 - 4k - 4.',
        options: [
          {
            text: 'k = -2',
            isCorrect: true,
      ...
      {
        question: 'Find the equation of the circle with center (3, -2) and radius 5.',
        options: [
          {
            text: '(x - 3)^2 + (y + 2)^2 = 25',
            isCorrect: true,
      ...
      },
      {
        ...
        options: [
          ...
          { text: 'After 6 hours, there will be 1200 bacteria.', isCorrect: false },
          { text: 'After 6 hours, there will be 3200 bacteria.', isCorrect: false },
